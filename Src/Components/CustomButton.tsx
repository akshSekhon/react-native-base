...
const CustomButton: FC<props> = ({
    ...
    if (bgColors?.length <= 0) {
        btnColors = [colors.bg_action, colors.bg_action]
    }
    ...
    return (
        ...
        >
            <>
                <LinearGradient
                    colors={!isdisable ? colorArr : [colors.bg_info, colors.bg_info]}
                    style={{ ...styles.linearGradiant, bottom: disableBottomLine ? 0 : 2, marginHorizontal: disableBottomLine ? 0 : 0.1, ...innerContainerStyle }}
