...
interface Props extends ViewStyle {
    ...
    activeCompo?: React.ReactNode
    inActiveCompo?: React.ReactNode
    onValueChange?: (val: boolean) => void
}

const ToggleButton: FC<Props> = ({ defaultValue, activeCompo, inActiveCompo, isActive, onValueChange }) => {
                    ...
                    {active ? (
                        <>
                            {activeCompo ?
                                { activeCompo }
                                :
                                <ImageHelper.svgs.RadioButton_On style={{ color: iconColor }} />
                            }
                        </>
                    ) : (
                        ...
                        <>
                            {inActiveCompo ?
                                { inActiveCompo }
                                :
                                <ImageHelper.svgs.RadioButton_Off style={{ color: iconColor }} />
                            }
                        </>
