...
import { CreaterTabRouteList, TabBarRouteList } from './routes.type.ts';
...
const Tab = createBottomTabNavigator<CreaterTabRouteList>();
// create a component
const CreaterTabNavigator = () => {
    const { colors, comnViewStyles, textStyles, lang } = getStyles(ThemeContext)
    const activeRoute = Modules.Creater
    return (
...
export default CreaterTabNavigator;
